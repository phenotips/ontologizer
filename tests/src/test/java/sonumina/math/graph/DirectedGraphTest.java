...
public class DirectedGraphTest
{
    ...
    {
        DirectedGraph<TestData> graph = new DirectedGraph<>();
    ...
    {
        final DirectedGraph<TestData> graph = new DirectedGraph<>();
        ...
        /*
         * Link the vertices as follow (always top down direction): root / |\ / | \ a->b c / \ d e | | | f \ / g
         */

        graph.addEdge(new Edge<>(root, a));
        graph.addEdge(new Edge<>(root, b));
        graph.addEdge(new Edge<>(root, c));
        graph.addEdge(new Edge<>(a, b));
        graph.addEdge(new Edge<>(c, d));
        ...
        HashSet<TestData> vertices = new HashSet<>();
        while (iter.hasNext()) {
        ...
        /*
         * root should have three outgoing edges linking root with a,b and c
         */
        ...
        /* Shortest path stuff */
        final HashMap<TestData, Integer> distanceMap = new HashMap<>();
        ...
        HashSet<TestData> sub = new HashSet<>();
        sub.add(root);
        sub.add(b);
        sub.add(e);
        sub.add(f);
        ...
        final HashSet<TestData> visited = new HashSet<>();
        ...
        class MyVisitor implements IVisitor<TestData>
        {
            ...
            public boolean visited(TestData vertex)
            {
                ...
                if (this.prev == e) {
                    Assert.assertEquals(f, vertex);
                }
                if (this.prev == g) {
                    Assert.assertTrue(vertex == d || vertex == e);
                }
                if (this.prev == a) {
                    Assert.assertTrue(vertex == b || vertex == c);
                }
    ...
    {
        /*
         * Build a graph like this 0 / \ / \ 1 4 / \ / \ 2 3 5 6
         */
        ...
        graph.addEdge(new Edge<>(n0, n1));
        graph.addEdge(new Edge<>(n1, n2));
        graph.addEdge(new Edge<>(n1, n3));
        graph.addEdge(new Edge<>(n0, n4));
        graph.addEdge(new Edge<>(n4, n5));
        graph.addEdge(new Edge<>(n4, n6));
