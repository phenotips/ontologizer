...
public class TermIDTest
{
    ...
    public void test()
    {
        ...
        TermID gid5 = new TermID(TermID.DEFAULT_PREFIX, 0352623);
        TermID gid6 = new TermID(TermID.DEFAULT_PREFIX, 0120211);
        TermID gid7 = new TermID(TermID.DEFAULT_PREFIX, 120211);
