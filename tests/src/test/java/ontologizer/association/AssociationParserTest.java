...
public class AssociationParserTest
{
    ...
    public void testSimple() throws IOException, OBOParserException
    {
        ...
        AssociationParser ap =
            new AssociationParser(ASSOCIATION_FILE, new TermContainer(oboParser.getTermMap(), "", ""));
        Assert.assertEquals(ap.getFileType(), AssociationParser.Type.GAF);
        Assert.assertEquals(87599, ap.getAssociations().size());
    ...
    public void testSkipHeader() throws IOException, OBOParserException
    {
        ...
        AssociationParser ap =
            new AssociationParser(tmp.getAbsolutePath(), new TermContainer(oboParser.getTermMap(), "", ""));
