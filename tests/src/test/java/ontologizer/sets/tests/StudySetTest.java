...
class InternalDatafiles extends Datafiles
{
    public InternalDatafiles()
    {
        ...
        Term c6 = new Term("GO:0000006", "C6", new ParentTermID(c3.getID(), TermRelation.IS_A),
            new ParentTermID(c2.getID(), TermRelation.IS_A));
        Term c7 = new Term("GO:0000007", "C7", new ParentTermID(c5.getID(), TermRelation.IS_A),
            new ParentTermID(c6.getID(), TermRelation.IS_A));
        ...
        HashSet<TermID> tids = new HashSet<>();
        for (Term term : terms) {
            tids.add(term.getID());
        }
        ...
        this.assoc.addAssociation(new Association(new ByteString("item1"), new TermID(TermID.DEFAULT_PREFIX, 4)));
        this.assoc.addAssociation(new Association(new ByteString("item1"), new TermID(TermID.DEFAULT_PREFIX, 11)));

        this.assoc.addAssociation(new Association(new ByteString("item2"), new TermID(TermID.DEFAULT_PREFIX, 10)));
        this.assoc.addAssociation(new Association(new ByteString("item2"), new TermID(TermID.DEFAULT_PREFIX, 13)));

        this.assoc.addAssociation(new Association(new ByteString("item3"), new TermID(TermID.DEFAULT_PREFIX, 7)));
        this.assoc.addAssociation(new Association(new ByteString("item3"), new TermID(TermID.DEFAULT_PREFIX, 15)));

        this.assoc.addAssociation(new Association(new ByteString("item4"), new TermID(TermID.DEFAULT_PREFIX, 12)));
        this.assoc.addAssociation(new Association(new ByteString("item4"), new TermID(TermID.DEFAULT_PREFIX, 13)));
        this.assoc.addAssociation(new Association(new ByteString("item4"), new TermID(TermID.DEFAULT_PREFIX, 14)));

        this.assoc.addAssociation(new Association(new ByteString("item5"), new TermID(TermID.DEFAULT_PREFIX, 6)));
        this.assoc.addAssociation(new Association(new ByteString("item5"), new TermID(TermID.DEFAULT_PREFIX, 14)));
        ...
        DirectedGraph<String> graphWithItems = new DirectedGraph<>();
        for (Term term : terms) {
        ...
        for (Term term : terms) {
            for (ParentTermID pid : term.getParents()) {
                graphWithItems.addEdge(new Edge<>(this.graph.getTerm(pid.termid).getName(), term.getName()));
            }
        }
        ...
        for (Gene2Associations g2a : this.assoc) {
            for (TermID tid : g2a.getAssociations()) {
                graphWithItems.addEdge(new Edge<>(this.graph.getTerm(tid).getName(), g2a.name().toString()));
            }
        }
...
{
    @Test
    public void testEnumerateWithNonExistentTerms() throws Exception
    {
    ...
    public void testEnumerateOnInternal()
    {
        ...
        Assert.assertEquals(5, gote.getAnnotatedGenes(new TermID("GO:0000001")).totalAnnotated.size());
        Assert.assertEquals(0, gote.getAnnotatedGenes(new TermID("GO:0000001")).directAnnotated.size());
        Assert.assertEquals(4, gote.getAnnotatedGenes(new TermID("GO:0000007")).totalAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000007")).directAnnotated.size());
        Assert.assertEquals(2, gote.getAnnotatedGenes(new TermID("GO:0000009")).totalAnnotated.size());
        Assert.assertEquals(0, gote.getAnnotatedGenes(new TermID("GO:0000009")).directAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000011")).totalAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000011")).directAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000012")).totalAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000012")).directAnnotated.size());
        Assert.assertEquals(2, gote.getAnnotatedGenes(new TermID("GO:0000013")).totalAnnotated.size());
        Assert.assertEquals(2, gote.getAnnotatedGenes(new TermID("GO:0000013")).directAnnotated.size());
        Assert.assertEquals(2, gote.getAnnotatedGenes(new TermID("GO:0000014")).totalAnnotated.size());
        Assert.assertEquals(2, gote.getAnnotatedGenes(new TermID("GO:0000014")).directAnnotated.size());
        ...
        Assert.assertEquals(7, gote.getTotalNumberOfAnnotatedTerms());

        Assert.assertEquals(4, gote.getAnnotatedGenes(new TermID("GO:0000007")).totalAnnotated.size());
        Assert.assertEquals(1, gote.getAnnotatedGenes(new TermID("GO:0000007")).directAnnotated.size());
        Assert.assertEquals(0, gote.getAnnotatedGenes(new TermID("GO:0000014")).totalAnnotated.size());
        Assert.assertEquals(0, gote.getAnnotatedGenes(new TermID("GO:0000014")).directAnnotated.size());
    ...
    @Test
    public void testEnumerateOnExternal() throws Exception
    {
        AssociationParserTest2 apt = new AssociationParserTest2();
        apt.setUp();
        ...
        Assert.assertEquals(apt.assocContainer.getAllAnnotatedGenes().size(),
            e.getAnnotatedGenes(rootTerm).totalAnnotated.size());
        ...
        // for (TermID tid : e)
        // System.out.println(String.format("Assert.assertEquals(%d,e.getAnnotatedGenes(new
        // TermID(\"%s\")).totalAnnotatedCount());",e.getAnnotatedGenes(tid).totalAnnotatedCount(),tid.toString()));
    }
}
