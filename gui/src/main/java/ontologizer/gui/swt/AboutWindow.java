...
public class AboutWindow extends ApplicationWindow
{
    ...
    public AboutWindow(Display display)
    {
        ...
        /* Styled text */
        final StyledText text = new StyledText(this.shell, SWT.BORDER | SWT.READ_ONLY | SWT.V_SCROLL | SWT.WRAP);
        text.setLayoutData(new GridData(GridData.GRAB_HORIZONTAL | GridData.GRAB_VERTICAL
        ...
        text.setStyleRange(
            new StyleRange(homepageLinkStart, homepageText.length(), display.getSystemColor(SWT.COLOR_BLUE), null));
