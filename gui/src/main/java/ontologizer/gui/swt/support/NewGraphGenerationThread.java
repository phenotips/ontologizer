...
/**
 * Generates the graph by executing DOT. When finished the layoutFinished method of the specified constructor argument
...
public class NewGraphGenerationThread extends Thread
{
     ...
     *
     * @param gfxOutFilename defines the name of the graphics which should be generated. Specifying null leads to a
     *            layout of the graph.
     */
    ...
    public void run()
    {
        try {
            ...
            if (this.gfxOutFilename != null) {
                gfxFile = new File(this.gfxOutFilename);
            } else {
                gfxFile = null;
            }

            this.support.writeDOT(dotTmpFile);
            ...
            if (gfxFile != null) {
                ...
                args = new String[] {
                this.dotCMDPath, dotTmpFile.getCanonicalPath(),
            ...
            this.display.syncExec(new Runnable()
            {
                ...
                public void run()
                {
                    NewGraphGenerationThread.this.support.layoutFinished(success,
