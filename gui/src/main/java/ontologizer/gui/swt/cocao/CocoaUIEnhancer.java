...
/**
 * Provide a hook to connecting the Preferences, About and Quit menu items of the Mac OS X Application menu when using
 * the SWT Cocoa bindings.
 * <p>
 * This code does not require the Cocoa SWT JAR in order to be compiled as it uses reflection to access the Cocoa
 * specific API methods. It does, however, depend on JFace (for IAction), but you could easily modify the code to use
 * SWT Listeners instead in order to use this class in SWT only applications.
 * </p>
 * <p>
 * This code was influenced by the
 * <a href="http://www.simidude.com/blog/2008/macify-a-swt-application-in-a-cross-platform-way/" >CarbonUIEnhancer from
 * Agynami</a> with the implementation being modified from the <a href=
...
public class CocoaUIEnhancer
{
     ...
     *
     * @param appName The name of the application. It will be used to customize the About and Quit menu items. If you do
     *            not wish to customize the About and Quit menu items, just pass <tt>null</tt> here.
     */
    ...
    /**
     * Hook the given Listener to the Mac OS X application Quit menu and the IActions to the About and Preferences
     * menus.
     *
        ...
        throws Exception
    {
        ...
        if (this.appName != null) {
            Object nsStr = invoke(nsstringCls, "stringWith", new Object[] { "About " + this.appName });
        ...
        if (this.appName != null) {
            ...
            Object nsStr = invoke(nsstringCls, "stringWith", new Object[] { "Quit " + this.appName });
