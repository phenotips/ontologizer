 ...
 */
public abstract class AbstractGOGraphGenerationThread extends NewGraphGenerationThread
    implements IGraphGenerationSupport, IDotAttributesProvider
{
    ...
    {
        GODOTWriter.writeDOT(this.graph, dotFile, this.emanatingTerm, this.leafTerms, this);
    }
}
