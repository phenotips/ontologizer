...
public class GeneLister
{
    ...
    public static void main(String[] args)
    {
        try {
            ...
            options.addOption("t", "termid", true,
                "Specifies the term from which the annotated genes are listed. Required");
            ...
            try {
                ...
                termId = new TermID(TermID.DEFAULT_PREFIX, termidInt);
            ...
            if (direct) {
                genes = annotatedGenes.directAnnotated;
            } else {
                genes = annotatedGenes.totalAnnotated;
            }
