    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try {
            ...
            try (FileWriter out = new FileWriter(outFile)) {
                ...
                /*
                 * // A file to hold some results String outFileName = GOpath + "Testout.txt"; File outFile = new
                 * File(outFileName); FileWriter outFileWriter = new FileWriter(outFile); for (String term : goTerms) {
                 * // getting name String goName = goTermCont.getGOName(term); // getting children Set<String> children
                 * = goGraph.getTermsDescendants(term); String line = term + "\t'" + goName + "'\t" + children.size() +
                 * "\n"; //System.out.println("Term: " + term + " Name: " + goName + " Children: " + children.size());
                 * //System.out.println(line); outFileWriter.write(line); } outFileWriter.close();
                 */
            }
