...
{
    /**
     * The required argument stuff of the jakarta cli didn't work as expeced, so we have to do this manually. If
     * specifed argument is not found an appropriate error message is written the program exited.
     *
     * @param cmd
     * @param name
     * @return
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            // options.addOption(new Option("d","dot",false,"For every studyset analysis write out an addiotional .dot
            // file containing significant nodes usable for GraphViz."));
            ...
            HashMap<String, StudySetResultList> studResListsHash = new HashMap<>();
