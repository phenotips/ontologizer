...
public class Edge<Type>
{
    ...
    /**
     * Returns the weight of an edge. The default implementation returns always 1 and hence must be overwritten by
     * subclasses in order to return different weights.
     *
     * @return
     */
