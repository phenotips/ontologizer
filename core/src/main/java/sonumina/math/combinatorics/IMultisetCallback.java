...
public interface IMultisetCallback
{
    ...
    /**
     * Method is called when a new element is to be added into the multi set. Use elementList[pos] to query which
     * element it is. You can abort to consider any sub problems by returning -1.
     *
