...
/**
 * A data structure to hold a pool of references. Simpler than a factory.
 *
...
{
    /**
     * The container for all refs. Have to use a HashMap here, as it is not possible to retrieve the reference via a
     * HashSet.
     */
