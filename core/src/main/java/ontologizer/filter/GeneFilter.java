...
/**
 * This class is resonsible for managing the GeneFilter stuff we can be used to filter genes. Currently a filter is a
 * plain ascii file containing two columns which represent the mapping.
 *
