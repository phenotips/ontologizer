...
/**
 * Specifies the rule how terms should be enriched in sampling of artificial gene sets. For an arbitary number of terms
 * a rule can be added by specifying the percentage of the term's genes that should appear in the sampled set.
 * Additionally, one can specify another integer number specifying the percentage of the rest of the terms to appear in
 * the sampled set.
 *
 * @author grossman
 */
public class PercentageEnrichmentRule implements Iterable<TermID>
{
     ...
     *
     * @param perc the percentage as an integer value between 0 and 100.
     */
     ...
     * @param perc the term's sampling percentage (has to be between 0 and 100)
     */
