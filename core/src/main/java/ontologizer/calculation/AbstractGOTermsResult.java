...
/**
 * An abstraction of any result containing GO terms utilizing AbstractGOTermProperties.
 *
...
public class AbstractGOTermsResult implements Iterable<AbstractGOTermProperties>
{
    ...
    /**
     * Returns the size of the result list, i.e., through how many elements you can iterate.
     *
     * @return
     */
    public int getSize()
