...
/**
 * Taken from http://blog.javia.org/docs/Gamma.java with minor modifications. Also see
 * http://blog.javia.org/implementing-the-lgamma-function-in-java/.
 */
/*
 * Author Mihai Preda, 2006. The author disclaims copyright to this source code. The method lgamma() is adapted from
 * FDLIBM 5.3 (http://www.netlib.org/fdlibm/), which comes with this copyright notice:
 * ==================================================== Copyright (C) 1993 by Sun Microsystems, Inc. All rights
 * reserved. Developed at SunSoft, a Sun Microsystems, Inc. business. Permission to use, copy, modify, and distribute
 ...
 * http://en.wikipedia.org/wiki/Lanczos_approximation http://en.wikipedia.org/wiki/Stirling%27s_approximation
 * http://www.gnu.org/software/gsl/ http://jakarta.apache.org/commons/math/ http://my.fit.edu/~gabdo/gamma.txt
 */
...
public class Gamma
{
    ...
    public static void main(String argv[])
    {
        ...
        if (doBenchmark) {
            ...
            /*
             * t1 = System.currentTimeMillis(); for (int r = 0; r < N; ++r) { for (int i = 1; i < 171; ++i) { c =
             * lanczosLGamma9(i); } } t2 = System.currentTimeMillis(); System.out.println("Lanczos 8 : " + (t2 - t1));
             */
    ...
    private static final double a0 = 7.72156649015328655494e-02,
