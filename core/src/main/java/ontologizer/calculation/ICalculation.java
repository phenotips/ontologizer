...
public interface ICalculation
{
    ...
    /**
     * Allows performing calculations on the single StudySet level. This makes more sense than acting on whole
     * directories.
     *
     * @param graph
    ...
    /**
     * Returns whether the calculation method supports multiple test correction.
     *
     * @return
     */
