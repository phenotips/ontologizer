...
/**
 * This class handles the file i/o. Files are cached in the cache directory.
 *
 * @author Sebastian Bauer
 */
public class FileCache
{
    ...
    /**
     * Starts to open the given url. If file is in cache, the file name in this cache is returned otherwise null.
     *
     * @param url
     * @return
     * @throws IOException
    ...
    public static String open(final String url, FileDownload ready) throws IOException
    {
        ...
        /*
         * Okay, it's neither about to be downloaded nor in the cache. So, start the download process now.
         */
        File destFile;
    ...
    /**
     * Returns the cached filename. Note that the function may block the calling task until the file is retrieved!
     *
     * @param url
     * @return
     * @throws IOException
        ...
        InterruptedException
    {
        ...
        /**
         * Handles the FileDownload Callback. The given lock object is notified once the download has been completed,
         * thus, a synchron download can be mimiced.
         *
         * @author Sebastian Bauer
         */
        class SynchronDownloaderCallback implements FileCache.FileDownload
        {
            ...
            private SynchronDownloaderCallback(Object lock)
            {
                this.lock = lock;
            }
    ...
    /**
     * Returns whether an open XXXBlocking call would block or not.
     *
     * @param url
     * @return
     */
    ...
    /**
     * Returns a formatted string that represents the time at which the given URL was downloaded.
     *
     * @param url
     * @return
     */
    ...
    public static String getPathInfo(String url)
    {
        synchronized (downloadHashMap) {
            ...
            if (fs == FileState.NOT_CACHED) {
                return "Not cached";
            }
            if (fs == FileState.WAITING) {
                return "Waiting for download";
            }
            if (fs == FileState.LOCAL) {
                return "Local";
            }
