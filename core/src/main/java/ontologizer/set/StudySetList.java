...
public class StudySetList implements Iterable<StudySet>
{
    ...
    /**
     * Constructs the StudySetList. For every file in the given path (whose name's suffix matches suffix) a separate
     * study set is created.
     *
     * @param path defines the path to the directory where all the study files are placed.
     * @param suffix only study files with the given suffix are consideres. Use an empty sting if the suffix is
     *            irrelevant.
     */
    public StudySetList(final String path, final String suffix)
    {
        /*
         * do not accept any files that start with `.'. or end with the given suffix
         */
    ...
    {
        /**
         * Contains the name of all participating genenames of all studies.
         */
    ...
    /**
     * Returns the size of the study list (i.e. the number of study sets contained within the list)
     *
     * @return
     */
    public int size()
