...
/**
 * This class is responsible to manage all test correction methods (i.e. objects of classes implememting the
 * ITestCorrection interface)
 *
...
public class TestCorrectionRegistry
{
    ...
    private static HashMap<String, AbstractTestCorrection> correctionMap =
        new HashMap<String, AbstractTestCorrection>();

    /**
     * Registers the given TestCorrection Class.
     *
     * @param testCorrection which should be registered.
     */
