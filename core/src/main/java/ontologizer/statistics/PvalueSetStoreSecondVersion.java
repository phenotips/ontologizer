...
public class PvalueSetStoreSecondVersion implements Iterable<PValue[]>
{
    ...
    /**
     * A class to hold the deflated p values. Deflated p values consist of two arrays. One holds the p values, the other
     * holds the indices of the p values in the original array.
     */
