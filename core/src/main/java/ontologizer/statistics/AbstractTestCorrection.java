...
/**
 * A multiple test correction... TODO: Write more (theory) and adapt the API to fit more procedures.
 *
...
{
    /**
     * Perform multiple test correction on p values originating from the given p value calculation.
     *
     * @param pValueCalculation an object implementing the p value calculation.
     * @return the adjusted p values matching the order of the the p values of the
     */
    ...
    /**
     * Returns the number of pvalues that don't have the ignoreAtMTC attribute set.
     *
     * @param p
     * @return
     */
    ...
    /**
     * Returns an array of all raw p values that don't have the ignoreAtMTC attribute set.
     *
    ...
    /**
     * Enforce monotony contrains of the p values (i.e. that adjusted p values of increasing p values is increasing as
     * well)
     *
     * @param p specfies the p values array which has to be already in sorted order!
     */
