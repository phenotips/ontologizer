...
public final class Util
{
    ...
    /**
     * Returns the File object for the directory where the application can store persistent data. If directory doesn't
     * exist it will be created.
     *
     * @param appName specifies the name of the application, from which the name of the directory is derived.
