...
/**
 * A class writing dot files for the comparision of different calculation methods.
 *
...
public class DOTDumper
{
    ...
    /**
     * Note that the studyResList should result from the same study! (only different calculation methods and multiple
     * test corrections are allowed)
     *
     * @param studResList
     * @param file
     * @param alpha
