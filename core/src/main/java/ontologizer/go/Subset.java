...
/**
 * This class represents a single subset. Terms can be accompanied by subsets to restrict the ontology for certain
 * purposes.
 *
...
public class Subset
{
    ...
    /**
     * Creates a subset from the given string. The first part is made of the reference id while the second part defines
     * a user presentable description.
     *
     * @param str
     * @return
     */
